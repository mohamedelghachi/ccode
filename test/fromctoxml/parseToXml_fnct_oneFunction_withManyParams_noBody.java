 ...
 */
public class parseToXml_fnct_oneFunction_withManyParams_noBody {
    
    public parseToXml_fnct_oneFunction_withManyParams_noBody() {
    }
    ...
    public void testMain() throws Exception {
        String inputFileName = "fnct_oneFunction_withManyParams_noBody";
