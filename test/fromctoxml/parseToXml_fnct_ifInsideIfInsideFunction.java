 ...
 */
public class parseToXml_fnct_ifInsideIfInsideFunction {
    
    public parseToXml_fnct_ifInsideIfInsideFunction() {
    }
    ...
    public void testMain() throws Exception {
        String inputFileName = "fnct_ifInsideIfInsideFunction";
