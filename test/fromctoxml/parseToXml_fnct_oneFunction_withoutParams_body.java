 ...
 */
public class parseToXml_fnct_oneFunction_withoutParams_body {
    
    public parseToXml_fnct_oneFunction_withoutParams_body() {
    }
    ...
    public void testMain() throws Exception {
        String inputFileName = "fnct_oneFunction_withoutParams_body";
